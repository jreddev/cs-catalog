...
// Core, SE, Elective, 100, 200, 300, 400, 500,
// Math, Machine Learning and AI (MLA), Design and HCI (HCI), Systems, Data,
// Essential, Theory, Frontend, Graphics
...
const courses = [
  ...
  },
  {
    ...
    credits: 3,
    prereq_id: 224,
    category: ["elective", "Systems", "300", "Theory"],
    note: null,
    instructors: [
      {
        first_name: "",
  ...
  },
  {
    ...
    credits: 3,
    prereq_id: 240,
    category: ["elective", "300", "Graphics", "Data"],
    note: null,
    instructors: [
      {
        first_name: "",
  ...
  },
  {
    ...
    credits: 3,
    prereq_id: 355,
    category: ["elective", "Graphics", "400"],
    note: "MATH 213",
    instructors: [
      {
        first_name: "Parris",
  ...
  },
  {
    ...
    credits: 3,
    prereq_id: 324,
    category: ["elective", "Systems", "400", "Data"],
    note: null,
    instructors: [
      {
        first_name: "Staff",
  ...
  },
  {
    ...
    credits: 3,
    prereq_id: 240,
    category: ["elective", "500", "Math", "Systems", "Theory"],
    note: "MATH 213 + MATH 215",
    instructors: [
      {
        first_name: "Sean",
